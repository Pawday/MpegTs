...
static void test_pmt_from_single_packet(void)
{
    ...
    bool packet_parse_status =
        mpeg_ts_search_packet(&packet, packet_with_small_pmt.data, packet_with_small_pmt.size);
...
static void test_pmt_from_2_packets(void)
{
    ...
    bool packet_1_parse_status =
        mpeg_ts_search_packet(&packet_1, packet_data_1.data, packet_data_1.size);
    ...
    bool packet_2_parse_status =
        mpeg_ts_search_packet(&packet_2, packet_data_2.data, packet_data_2.size);
...
static void test_pmt_builder_messup_packets(void)
{
    ...
    bool unrelated_packet_parse_status = mpeg_ts_search_packet(&unrelated_packet,
